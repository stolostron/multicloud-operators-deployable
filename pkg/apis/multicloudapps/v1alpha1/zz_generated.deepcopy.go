...
import (
	multicloudappsv1alpha1 "github.com/open-cluster-management/multicloud-operators-placementrule/pkg/apis/multicloudapps/v1alpha1"
...
func (in *DeployableSpec) DeepCopyInto(out *DeployableSpec) {
	*out = *in
	...
	if in.Placement != nil {
		...
		*out = new(multicloudappsv1alpha1.Placement)
		(*in).DeepCopyInto(*out)
	}
	if in.Overrides != nil {
